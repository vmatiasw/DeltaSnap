...
def DeltaDB_setup(
    ...
    """
    Sets up and returns a configured DeltaDB object.

    This function provides a shortcut to initialize a DeltaDB instance with
    ...
    Args:
        ...
        db_orm (Literal['sqlalchemy']): The ORM to be used.
        repository (optional): A repository instance to interact with the database.
        base (optional): A base class for model mapping.

    Returns:
        DeltaDB: A configured DeltaDB instance.
    """
    return DeltaDB(db_type, db_orm, repository, base)
