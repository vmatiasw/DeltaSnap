def test_iniciar_partida(repository, game, delta_db):
    ...
    captura_inicial = delta_db.capture_all_tables()
    ...
    captura_final = delta_db.capture_all_tables()
    ...
    changes, created, deleted = delta_db.diff_captures(captura_inicial, captura_final)
