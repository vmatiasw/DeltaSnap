...
def __get_sqlalchemy_adapter(db_config):
    ...
    from src.deltasnap.infrastructure.adapters.DBMetadata.SQLAlchemyMetadataAdapter import (
...
def __get_django_adapter(db_config):
    ...
    """
    from src.deltasnap.infrastructure.adapters.DBMetadata.DjangoDBMetadata import (
        DjangoDBMetadata,
    )
